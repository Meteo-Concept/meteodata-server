/**
 * @file concept500_message.h
 * @brief Definition of the Concept500Message class
...
#ifndef CONCEPT500_MESSAGE_H
#define CONCEPT500_MESSAGE_H
 ...
 */
class Concept500Message : public LiveobjectsMessage
{
public:
	explicit Concept500Message(DbConnectionObservations& db);
