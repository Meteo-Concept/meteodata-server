/**
 * @file lse01_soil_sensor_message.h
 * @brief Definition of the Lse01SoilSensorMessage class
...
#ifndef LSE01_SOIL_SENSOR_MESSAGE_H
#define LSE01_SOIL_SENSOR_MESSAGE_H
...
{
/**
 * @brief A Message able to receive and store a Dragino LSE01 soil sensor
 * IoT payload from a low-power connection (LoRa, NB-IoT, etc.)
 */
class Lse01SoilSensorMessage : public LiveobjectsMessage
{
public:
	/**
...
#endif /* LSE01_SOIL_SENSOR_MESSAGE_H */
