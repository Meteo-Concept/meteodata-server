/**
 * @file sn50v3_probe6470_message.cpp
 * @brief Implementation of the Sn50v3Probe6470Message class
...
void Sn50v3Probe6470Message::ingest(const CassUuid&, const std::string& payload, const date::sys_seconds& datetime)
{
	...
	if (adc0 < 1200) {
		float lr0 = std::log(adc0*r0/(ADC_POWER-adc0));
...
Observation Sn50v3Probe6470Message::getObservation(const CassUuid& station) const
{
	Observation obs;
	obs.station = station;
...
json::object Sn50v3Probe6470Message::getDecodedMessage() const
{
	return json::object{
