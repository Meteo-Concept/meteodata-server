...
namespace meteodata {
	...
	public:
		...
		struct Values
		{
			...
			float leafTemp_max[2];
			float outsideTemp_max;
			float soilTemp_max[4];
			float extraTemp_max[3];

			// Values from 18h to 18h
			float insideTemp_min;
			float leafTemp_min[2];
			float outsideTemp_min;
			float soilTemp_min[4];
			float extraTemp_min[3];

			// Values from 0h to 0h
			float barometer_min;
			float barometer_max;
			float barometer_avg;
			int leafWetnesses_min[2];
			int leafWetnesses_max[2];
			int leafWetnesses_avg[2];
			...
			float leafTemp_avg[2];
			float outsideTemp_avg;
			float soilTemp_avg[4];
			float extraTemp_avg[3];
		};
