/**
 * @file meteo_france_downloader_standalone.cpp
...
int main(int argc, char** argv)
{
	...
	int retry = 0;
	for (auto it = mfStations.cbegin() ; it != mfStations.cend() ;) {
		...
		MeteoFranceApiDownloader downloader{std::get<0>(station), std::get<2>(station), db, apiKey};
		try {
