/**
 * @file barani_thermohygro_2026_message.h
 * @brief Definition of the BaraniThermohygro2026Message class
...
#ifndef BARANI_THERMOHYGRO_2026_MESSAGE_H
#define BARANI_THERMOHYGRO_2026_MESSAGE_H
 ...
 */
class BaraniThermohygro2026Message : public LiveobjectsMessage
{
public:
	explicit BaraniThermohygro2026Message(DbConnectionObservations& db);
...
private:
	...
	static constexpr char BARANI_RAINCORR_CACHE_KEY[] = "barani_correction_clicks";
};

}

#endif /* BARANI_THERMOHYGRO_2026_MESSAGE_H */
