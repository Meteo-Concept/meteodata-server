/**
 * @file mbdatameteohubmessage.cpp
 * @brief Implementation of the MBDataMeteohubMessage class
...
MBDataMeteohubMessage::MBDataMeteohubMessage(date::sys_seconds datetime,  const std::string& content, std::experimental::optional<float> rainfallOver50Min, const TimeOffseter& timeOffseter) :
...
void MBDataMeteohubMessage::populateDataPoint(const CassUuid, CassStatement* const) const
{
	// Not implemented, no one cares
}

void MBDataMeteohubMessage::populateV2DataPoint(const CassUuid station, CassStatement* const statement) const
{
	/*************************************************************/
