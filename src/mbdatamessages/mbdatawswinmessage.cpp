...
MBDataWsWinMessage::MBDataWsWinMessage(std::istream& entry, std::experimental::optional<float> rainfallOver50Min, const TimeOffseter& timeOffseter) :
