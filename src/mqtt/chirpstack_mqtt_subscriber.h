/**
 * @file chirpstack_mqtt_subscriber.h
 * @brief Definition of the ChirpstackMqttSubscriber class
 ...
 */
#ifndef METEODATA_SERVER_CHIRPSTACK_MQTT_SUBSCRIBER_H
#define METEODATA_SERVER_CHIRPSTACK_MQTT_SUBSCRIBER_H
...
class ChirpstackMqttSubscriber : public MqttSubscriber
{
public:
...
#endif //METEODATA_SERVER_CHIRPSTACK_MQTT_SUBSCRIBER_H
