...
Observation VantagePro2ArchiveMessage::getObservation(CassUuid station) const
{
    ...
    result.dewpoint = {
            _data.outsideTemp != 32767 && _data.outsideHum != 255,
    ...
    result.thswindex = {
            _data.outsideTemp != 32767 && _data.avgWindSpeed != 255 && _data.outsideHum != 255,
            thsw_index(
    ...
    result.windchill = {
            _data.outsideTemp != 32767 && _data.avgWindSpeed != 255,
    ...
    result.min_outside_temperature = { _data.minOutsideTemp != 32767, from_Farenheit_to_Celsius(_data.minOutsideTemp/10.0) };
    result.max_outside_temperature = { _data.maxOutsideTemp != -32768, from_Farenheit_to_Celsius(_data.maxOutsideTemp/10.0) };
