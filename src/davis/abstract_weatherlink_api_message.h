...
public:
	...
	enum class DataStructureType
	{
		...
		ENVIROMONITOR_ISS_ARCHIVE_RECORD = 7,
		ANEMOMETER_RECORD = 9,
		...
		WEATHERLINK_CONSOLE_BAROMETER_CURRENT_READING = 19,
		WEATHERLINK_CONSOLE_BAROMETER_ARCHIVE_RECORD = 20,
		WEATHERLINK_CONSOLE_ISS_CURRENT_READING = 23,
		WEATHERLINK_CONSOLE_ISS_ARCHIVE_RECORD = 24,
		WEATHERLINK_CONSOLE_LEAFSOIL_CURRENT_READING = 25,
		WEATHERLINK_CONSOLE_LEAFSOIL_ARCHIVE_RECORD = 26,
	};
